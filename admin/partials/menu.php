...
<aside id="mobileSidebar" class="fixed inset-y-0 left-0 z-40 w-72 bg-card-light border-r border-border-light transform -translate-x-full transition-transform duration-200 md:static md:translate-x-0 md:w-64 flex-shrink-0 md:transform-none flex flex-col">
  ...
  <nav class="mt-8 px-4">
    <ul>
      ...
      <li class="mt-2">
        <a href="collection.php" class="flex items-center gap-3 px-4 py-3 <?php echo $activePage === 'collection' ? 'bg-primary/10 text-primary rounded-lg font-semibold' : 'text-text-light hover:bg-gray-100 rounded-lg'; ?>">
          <span class="material-icons">collections_bookmark</span>
          Collection
        </a>
      </li>
      <li class="mt-2">
        <a href="customer.php" class="flex items-center gap-3 px-4 py-3 <?php echo $activePage === 'customer' || $activePage === 'customer-detail' ? 'bg-primary/10 text-primary rounded-lg font-semibold' : 'text-text-light hover:bg-gray-100 rounded-lg'; ?>">
