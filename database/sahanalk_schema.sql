...
-- Password uses BCrypt for secure encryption
-- To manually change password, use the generate-password-hash.php script or run:
-- UPDATE users SET password_hash = '$2y$10$...' WHERE username = 'admin';
-- (Generate hash using: php database/generate-password-hash.php "newpassword")
INSERT INTO users (username, password_hash, full_name, email, mobile, role_id, status) VALUES
('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrator', 'admin@sahanalk.com', '94770000000', 1, 'active')
