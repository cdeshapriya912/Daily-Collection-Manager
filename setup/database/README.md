...
1. **Via phpMyAdmin:**
   ...
   - Import: `setup/database/database_schema.sql`

2. **Via Command Line:**
   ```bash
   mysql -u root -proot -P 8889 < setup/database/database_schema.sql
   ```
...
1. **Import the schema:**
   ```bash
   mysql -u root -p < setup/database/database_schema.sql
   ```
