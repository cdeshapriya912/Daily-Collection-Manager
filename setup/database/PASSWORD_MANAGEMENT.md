...
```
http://localhost:8888/Daily-Collection-Manager/setup/database/change-password.php
```
...
```
http://localhost:8888/Daily-Collection-Manager/setup/database/generate-password-hash.php
```
...
**Via Web Interface:**
1. Go to `setup/database/change-password.php`
2. Select "Staff/User"
3. Username: `admin`
